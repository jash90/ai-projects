...
import { InlineMath, BlockMath, InlineLatex, BlockLatex } from './ReactKatex'
    ...
    <div className="p-6 space-y-6">
      ...
      <section className="space-y-4">
        ...
        <div>
          ...
          <BlockLatex>
            {String.raw`\begin{pmatrix} a & b \\ c & d \end{pmatrix} \begin{pmatrix} x \\ y \end{pmatrix} = \begin{pmatrix} ax + by \\ cx + dy \end{pmatrix}`}
          </BlockLatex>
        </div>
      ...
      <section className="space-y-4">
        ...
        <div>
          <p>
            Using KaTeX for simple math: <InlineMath>{String.raw`\alpha + \beta`}</InlineMath> and LaTeX for complex expressions: <InlineLatex>{String.raw`\frac{\partial f}{\partial x}`}</InlineLatex>
          </p>
        </div>
...
{`// Import components
import { InlineMath, BlockMath, InlineLatex, BlockLatex } from '@/features/markdown'

...
import type { TextFile as FileType } from '@/features/files/types'
...
import { FileEditor } from '@/features/files/components/FileEditor'
import { ThreadChat } from '@/features/chat/components/ThreadChat'
import { MobileNavigation, useIsMobile } from '@/shared/components/ui/MobileNavigation'
import { usePWAFeatures, useOfflineFiles } from '@/shared/hooks/usePWAFeatures'

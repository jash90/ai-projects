...
setup_environment_variables() {
    ...
    echo ""
    echo -e "${YELLOW}WAŻNE - NIE ustawiaj PORT ręcznie (Railway robi to automatycznie)${NC}"
    echo ""
    ...
    echo "DEFAULT_TOKEN_LIMIT_GLOBAL=100000"
    echo "DEFAULT_TOKEN_LIMIT_MONTHLY=50000"
